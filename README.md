...
## Contributing
As this repository serves as a **Research Archive** documenting the evolution of the project, we are not currently accepting pull requests for feature updates to the V2 codebase. However, we highly value academic and technical collaboration:
* **Discussion:** If you are interested in the fine-tuning methodology or the "Teacher-Student" distillation process used here, please open an **Issue** to start a discussion.
* **Dataset Usage:** If you utilize the V2 training set (57 downloads) for your own research, please credit this repository.
* **Active Development:** For contributions to the live production environment, please refer to the **Mock Trial AI V3** repository.
